...
class RestaurantesTest < ApplicationSystemTestCase
  ...
  test 'creating a Restaurante' do
    ...
    fill_in 'Adress', with: @restaurante.adress
    fill_in 'Mail', with: @restaurante.mail
    fill_in 'Name', with: @restaurante.name
    fill_in 'Phone number', with: @restaurante.phone_number
    fill_in 'Valoration', with: @restaurante.valoration
